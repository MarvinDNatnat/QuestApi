...
public class ChemistryCertificate {
	...
	public void formatChemistryCertificate(QisTransactionChemistry qisChemistry, PdfPTable tableReport,
		...
		if (fastingBloodSugar != null) {
			...
			if (qisChemistry.getFbs() != null && qisChemistry.getFbs().getFbs() != null) {
				...
				certificate.addToTable(leftTable, cell, "mmol/L   4.1-5.9", certificate.getFontDocNormal(),
						Element.ALIGN_LEFT);
			} else {
			...
			if (qisChemistry.getFbs() != null && qisChemistry.getFbs().getConventional() != null) {
				...
				certificate.addToTable(rightTable, cellBorder, String.valueOf(qisChemistry.getFbs().getConventional()),
						certificate.getFontDocValue(), Element.ALIGN_CENTER);
				certificate.addToTable(rightTable, cell, "mg/dl  75 -107", certificate.getFontDocNormal(),
						Element.ALIGN_LEFT);
		...
		if (uricAcid != null) {
			...
			if (qisChemistry.getUricAcid() != null && qisChemistry.getUricAcid().getUricAcid() != null) {
				certificate.addToTable(leftTable, cellBorder, String.valueOf(qisChemistry.getUricAcid().getUricAcid()),
						certificate.getFontDocValue(), Element.ALIGN_CENTER);
				certificate.addToTable(leftTable, cell, "mmol/L  155 - 428", certificate.getFontDocNormal(),
						Element.ALIGN_LEFT);
			} else {
				certificate.addToTable(leftTable, cell, " - NO RESULT - ", certificate.getFontDocAlert(),
						Element.ALIGN_CENTER);
			...
			if (qisChemistry.getUricAcid() != null && qisChemistry.getUricAcid().getConventional() != null) {
				...
				certificate.addToTable(rightTable, cellBorder,
						...
						Element.ALIGN_CENTER);
				certificate.addToTable(rightTable, cell, "mg/dl  2.60 - 7.18", certificate.getFontDocNormal(),
						Element.ALIGN_LEFT);
				certificate.addToTable(rightTable, cell, "", certificate.getFontDocNormal(), Element.ALIGN_LEFT);
			} else {
				cell.setColspan(4);
		...
		if (bloodUreaNitrogen != null) {
			...
			if (qisChemistry.getBun() != null && qisChemistry.getBun().getBun() != null) {
				certificate.addToTable(leftTable, cellBorder, String.valueOf(qisChemistry.getBun().getBun()),
						certificate.getFontDocValue(), Element.ALIGN_CENTER);
				certificate.addToTable(leftTable, cell, "mmol/L  2.5 - 7.5", certificate.getFontDocNormal(),
						Element.ALIGN_LEFT);
			} else {
				certificate.addToTable(leftTable, cell, " - NO RESULT - ", certificate.getFontDocAlert(),
						Element.ALIGN_CENTER);
			...
			if (qisChemistry.getBun() != null && qisChemistry.getBun().getConventional() != null) {
				...
				certificate.addToTable(rightTable, cellBorder, String.valueOf(qisChemistry.getBun().getConventional()),
						certificate.getFontDocValue(), Element.ALIGN_CENTER);
				certificate.addToTable(rightTable, cell, "mg/dl  7 - 21", certificate.getFontDocNormal(),
						Element.ALIGN_LEFT);
				certificate.addToTable(rightTable, cell, "", certificate.getFontDocNormal(), Element.ALIGN_LEFT);
			} else {
				cell.setColspan(4);
		...
		if (creatinine != null) {
			...
			if (qisChemistry.getCreatinine() != null && qisChemistry.getCreatinine().getCreatinine() != null) {
				certificate.addToTable(leftTable, cellBorder,
						...
						Element.ALIGN_CENTER);
				certificate.addToTable(leftTable, cell, "umol/L  " + (isMale ? "M: 71 - 115" : "F: 53 - 106"),
			...
			if (qisChemistry.getCreatinine() != null && qisChemistry.getCreatinine().getConventional() != null) {
				...
				certificate.addToTable(rightTable, cellBorder,
						...
						Element.ALIGN_CENTER);
				certificate.addToTable(rightTable, cell, "mg/dl  " + (isMale ? "M: 0.80 - 1.30" : "F: 0.60 - 1.20"),
						certificate.getFontDocNormal(), Element.ALIGN_LEFT);
				certificate.addToTable(rightTable, cell, "", certificate.getFontDocNormal(), Element.ALIGN_LEFT);
			} else {
				cell.setColspan(4);
		...
		if (lipidProfile != null) {
			...
			if (lipp != null && lipp.getCholesterol() != null) {
				...
				certificate.addToTable(leftTable, cellBorder, String.valueOf(lipp.getCholesterol()),
						certificate.getFontDocValue(), Element.ALIGN_CENTER);
				certificate.addToTable(leftTable, cell, "mmol/L  < 5.17", certificate.getFontDocNormal(),
						Element.ALIGN_LEFT);
			...
			if (lipp != null && lipp.getHdl() != null) {
				...
				certificate.addToTable(leftTable, cellBorder, String.valueOf(lipp.getHdl()),
						certificate.getFontDocValue(), Element.ALIGN_CENTER);
				certificate.addToTable(leftTable, cell, "mmol/L  0.9-2.21", certificate.getFontDocNormal(),
						Element.ALIGN_LEFT);

				certificate.addToTable(rightTable, cell, "", certificate.getFontDocValue(), Element.ALIGN_LEFT);
				certificate.addToTable(rightTable, cellBorder, String.valueOf(lipp.getHdlConventional()),
						certificate.getFontDocValue(), Element.ALIGN_CENTER);
				certificate.addToTable(rightTable, cell, "mg/dl  34.6-85", certificate.getFontDocNormal(),
						Element.ALIGN_LEFT);
				certificate.addToTable(rightTable, cell, "", certificate.getFontDocNormal(), Element.ALIGN_LEFT);
				withResult = true;
			}
			...
			if (lipp != null && lipp.getCholesterol() != null && lipp.getTriglycerides() != null
				...
				if (lipp.getLdl() != null) {
					...
					certificate.addToTable(rightTable, cellBorder, String.valueOf(lipp.getLdlConventional()),
							certificate.getFontDocValue(), Element.ALIGN_CENTER);
					certificate.addToTable(rightTable, cell, "mg/dl  96.15-157.70", certificate.getFontDocNormal(),
							Element.ALIGN_LEFT);
					certificate.addToTable(rightTable, cell, "", certificate.getFontDocNormal(), Element.ALIGN_LEFT);
					withResult = true;
				}
		...
		if (serumEnzymes != null) {
			...
			if (enzy != null && enzy.getSgptAlt() != null) {
				...
				certificate.addToTable(enzyTable, cellBorder, String.valueOf(enzy.getSgptAlt()),
						certificate.getFontDocValue(), Element.ALIGN_CENTER);
				certificate.addToTable(enzyTable, cell, "U/L  " + (isMale ? "M: 10 - 41" : "F: 5 - 31"),
						certificate.getFontDocNormal(), Element.ALIGN_LEFT);
				withResult = true;
			}
	...
	public void formatChemistryConsolidated(QisTransactionChemistry qisChemistry, PdfPTable tableReport,
		...
		if (fastingBloodSugar != null) {
			...
			if (qisChemistry.getFbs() != null && qisChemistry.getFbs().getFbs() != null) {
				certificate.addToTable(tableReport, cell,
						certificate.getDisplaySymbol(qisChemistry.getFbs().getFbs(), 4.1, 5.9),
						certificate.getDisplayFontRange(qisChemistry.getFbs().getFbs(), 4.1, 5.9, fontResult,
								fontResultRed),
						Element.ALIGN_RIGHT);
			} else {
			...
			certificate.addToTable(tableReport, cell, "4.1-5.9", fontUnit, Element.ALIGN_RIGHT);

			if (qisChemistry.getFbs() != null && qisChemistry.getFbs().getConventional() != null) {
				certificate.addToTable(tableReport, cell,
						"   " + certificate.getDisplaySymbol(qisChemistry.getFbs().getConventional(), 75.0, 107.0),
						certificate.getDisplayFontRange(qisChemistry.getFbs().getConventional(), 75.0, 107.0,
			...
			certificate.addToTable(tableReport, cell, "75 -107", fontUnit, Element.ALIGN_RIGHT);
			withData = true;
		}
		...
		if (uricAcid != null) {
			...
			if (qisChemistry.getUricAcid() != null && qisChemistry.getUricAcid().getUricAcid() != null) {
				certificate.addToTable(tableReport, cell,
						"   " + certificate.getDisplaySymbol(qisChemistry.getUricAcid().getUricAcid(), 155.0, 428.0),
						certificate.getDisplayFontRange(qisChemistry.getUricAcid().getUricAcid(), 155.0, 428.0,
								fontResult, fontResultRed),
						Element.ALIGN_RIGHT);
			} else {
				certificate.addToTable(tableReport, cell, NO_RESULT, fontNoResult, Element.ALIGN_RIGHT);
			...
			certificate.addToTable(tableReport, cell, "mmol/L", fontUnit, Element.ALIGN_RIGHT);
			certificate.addToTable(tableReport, cell, "155 - 428", fontUnit, Element.ALIGN_RIGHT);

			if (qisChemistry.getUricAcid() != null && qisChemistry.getUricAcid().getConventional() != null) {
				certificate.addToTable(tableReport, cell,
						certificate.getDisplaySymbol(qisChemistry.getUricAcid().getConventional(), 2.6, 7.18),
						certificate.getDisplayFontRange(qisChemistry.getUricAcid().getConventional(), 2.6, 7.18,
								fontResult, fontResultRed),
						Element.ALIGN_RIGHT);
			} else {
				certificate.addToTable(tableReport, cell, NO_RESULT, fontNoResult, Element.ALIGN_RIGHT);
			...
			certificate.addToTable(tableReport, cell, "mg/dl", fontUnit, Element.ALIGN_RIGHT);
			certificate.addToTable(tableReport, cell, "2.60 - 7.18", fontUnit, Element.ALIGN_RIGHT);
			withData = true;
		}
		...
		if (bloodUreaNitrogen != null) {
			...
			if (qisChemistry.getBun() != null && qisChemistry.getBun().getBun() != null) {
				certificate.addToTable(tableReport, cell,
						"   " + certificate.getDisplaySymbol(qisChemistry.getBun().getBun(), 2.5, 7.5),
						certificate.getDisplayFontRange(qisChemistry.getBun().getBun(), 2.5, 7.5, fontResult,
								fontResultRed),
						Element.ALIGN_RIGHT);
			} else {
				certificate.addToTable(tableReport, cell, NO_RESULT, fontNoResult, Element.ALIGN_RIGHT);
			}
			certificate.addToTable(tableReport, cell, "2.5 - 7.5", fontUnit, Element.ALIGN_RIGHT);
			certificate.addToTable(tableReport, cell, "   mmol/L", certificate.getFontDocNormal(), Element.ALIGN_RIGHT);

			if (qisChemistry.getBun() != null && qisChemistry.getBun().getConventional() != null) {
				cell.setRowspan(1);
				certificate.addToTable(tableReport, cell,
						"   " + certificate.getDisplaySymbol(qisChemistry.getBun().getConventional(), 7.0, 21.0),
						certificate.getDisplayFontRange(qisChemistry.getBun().getConventional(), 7.0, 21.0, fontResult,
								fontResultRed),
						Element.ALIGN_RIGHT);
			} else {
				certificate.addToTable(tableReport, cell, NO_RESULT, fontNoResult, Element.ALIGN_RIGHT);
			...
			certificate.addToTable(tableReport, cell, "mg/dl", fontUnit, Element.ALIGN_RIGHT);
			certificate.addToTable(tableReport, cell, "7 - 21", fontUnit, Element.ALIGN_RIGHT);
			withData = true;
		}
		...
		if (creatinine != null) {
			...
			if (qisChemistry.getCreatinine() != null && qisChemistry.getCreatinine().getCreatinine() != null) {
				certificate.addToTable(tableReport, cell,
						certificate.getDisplaySymbol(qisChemistry.getCreatinine().getCreatinine(), isMale ? 71.0 : 53.0,
								isMale ? 115.0 : 106.0),
						certificate.getDisplayFontRange(qisChemistry.getCreatinine().getCreatinine(),
								isMale ? 71.0 : 53.0, isMale ? 115.0 : 106.0, fontResult, fontResultRed),
						Element.ALIGN_RIGHT);
			} else {
				certificate.addToTable(tableReport, cell, NO_RESULT, fontNoResult, Element.ALIGN_RIGHT);
			}
			certificate.addToTable(tableReport, cell, "umol/L", fontUnit, Element.ALIGN_RIGHT);
			certificate.addToTable(tableReport, cell, isMale ? "M: 71 - 115" : "F: 53 - 106", fontUnit,
					Element.ALIGN_RIGHT);

			if (qisChemistry.getCreatinine() != null && qisChemistry.getCreatinine().getConventional() != null) {
				certificate.addToTable(tableReport, cell,
						certificate.getDisplaySymbol(qisChemistry.getCreatinine().getConventional(), isMale ? 0.8 : 0.6,
								isMale ? 1.3 : 1.2),
						certificate.getDisplayFontRange(qisChemistry.getCreatinine().getConventional(),
								isMale ? 0.8 : 0.6, isMale ? 1.3 : 1.2, fontResult, fontResultRed),
						Element.ALIGN_RIGHT);
				cell.setRowspan(2);
			} else {
				certificate.addToTable(tableReport, cell, NO_RESULT, fontNoResult, Element.ALIGN_RIGHT);
			...
			certificate.addToTable(tableReport, cell, "mg/dl", fontUnit, Element.ALIGN_RIGHT);
			certificate.addToTable(tableReport, cell, isMale ? "M: 0.80 - 1.30" : "F: 0.60 - 1.20", fontUnit,
					Element.ALIGN_RIGHT);
			withData = true;
		}
		...
		if (lipidProfile != null) {
			...
			if (lipp != null) {
				if (lipp.getCholesterol() != null) {
					...
					cell.setColspan(1);
					certificate.addToTable(tableReport, cell,
							certificate.getDisplaySymbol(lipp.getCholesterol(), 0.0, 5.17), certificate
									.getDisplayFontRange(lipp.getCholesterol(), 0.0, 5.17, fontResult, fontResultRed),
							Element.ALIGN_RIGHT);
					certificate.addToTable(tableReport, cell, "mmol/L", fontUnit, Element.ALIGN_RIGHT);
					certificate.addToTable(tableReport, cell, "< 5.17", fontUnit, Element.ALIGN_RIGHT);
				...
				if (lipp.getHdl() != null) {
					...
					cell.setColspan(1);
					certificate.addToTable(tableReport, cell, certificate.getDisplaySymbol(lipp.getHdl(), 0.9, 2.21),
							certificate.getDisplayFontRange(lipp.getHdl(), 0.9, 2.21, fontResult, fontResultRed),
							Element.ALIGN_RIGHT);
					certificate.addToTable(tableReport, cell, "mmol/L", fontUnit, Element.ALIGN_RIGHT);
					certificate.addToTable(tableReport, cell, "0.9-2.21", fontUnit, Element.ALIGN_RIGHT);

					certificate.addToTable(tableReport, cell,
							certificate.getDisplaySymbol(lipp.getHdlConventional(), 34.6, 85.0),
							certificate.getDisplayFontRange(lipp.getHdlConventional(), 34.6, 85.0, fontResult,
									fontResultRed),
							Element.ALIGN_RIGHT);
					certificate.addToTable(tableReport, cell, "mg/dl", fontUnit, Element.ALIGN_RIGHT);
					certificate.addToTable(tableReport, cell, "34.6-85", fontUnit, Element.ALIGN_RIGHT);
				...
				if (lipp.getCholesterol() != null && lipp.getTriglycerides() != null && lipp.getHdl() != null) {
					if (lipp.getLdl() != null) {
						...
						certificate.addToTable(tableReport, cell,
								certificate.getDisplaySymbol(lipp.getLdlConventional(), 96.15, 157.7),
								certificate.getDisplayFontRange(lipp.getLdlConventional(), 96.15, 157.7, fontResult,
										fontResultRed),
								Element.ALIGN_RIGHT);
						certificate.addToTable(tableReport, cell, "mg/dl", fontUnit, Element.ALIGN_RIGHT);
						certificate.addToTable(tableReport, cell, "96.15-157.70", fontUnit, Element.ALIGN_RIGHT);
					}
		...
		if (serumEnzymes != null) {
			...
			if (enzy != null && enzy.getSgptAlt() != null) {
				...
				cell.setColspan(1);
				certificate.addToTable(tableReport, cell,
						certificate.getDisplaySymbol(enzy.getSgptAlt(), isMale ? 10.0 : 5.0, isMale ? 41.0 : 31.0),
				...
				certificate.addToTable(tableReport, cell, isMale ? "M: 10 - 41" : "F: 5 - 31", fontUnit,
						Element.ALIGN_RIGHT);
				certificate.addToTable(tableReport, cell, "", fontUnit, Element.ALIGN_RIGHT);
